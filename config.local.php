 ...
 */
$config['db_host'] = 'devel.tieka.nl';
$config['db_name'] = 'csdb';
$config['db_user'] = 'csdb';
$config['db_password'] = 'henk1234';
...
$config['http_host'] = 'www.tieka.nl';
$config['http_path'] = '/cscart';

// Host and directory where software is installed on secure server
$config['https_host'] = 'www.tieka.nl';
...
$config['admin_index']    = 'ufadmin.php';
